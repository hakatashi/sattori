# 0038. 処理落ち早期検知(stutter probe)を削除する
...
> **注**: 本決定に記述されている `worker/recording_common.py` は、PR #206 / [`0041`](0041-worker-recording-package-split.md) により `worker/recording/` パッケージへ分割されました。
