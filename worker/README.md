...
> **ここにワーカー側の分岐を足さないこと。** 理由と採らなかった選択肢は
...
- [`docs/reports/2026-08-11-th20-slow-motion-local.md`](../docs/reports/2026-08-11-th20-slow-motion-local.md)
  —— `th20_01.rpy`(HARD)をこのリポジトリのローカル環境でフル尺録画した記録。生データの
  重複フレーム率 50.1%(理論値50%)、配信版 0.0%、配信版の尺は生データのちょうど1/2。
  MOD の待機・処理落ち検知・fps 表示補正・進捗報告がそれぞれ意図どおりスケールしたことも
  個別に確認してある。
...
コスト構造で最大のレバレッジ(`docs/research/aws-region-cost-analysis.md` §6)なので、平均値で
